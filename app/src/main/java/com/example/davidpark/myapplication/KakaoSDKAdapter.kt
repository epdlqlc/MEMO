...
class KakaoSDKAdapter : KakaoAdapter() {
    ...
    override fun getSessionConfig(): ISessionConfig {
        return object : ISessionConfig {
            override fun getAuthTypes(): Array<AuthType> {
                return arrayOf(AuthType.KAKAO_LOGIN_ALL) // 여기서 타입 변경가능합니다.
            }
    ...
    override fun getApplicationConfig(): IApplicationConfig {
        return IApplicationConfig() // 현재 최상단에 위치하고 있는 Activity. topActivity가 아니거나 ApplicationContext를 넣는다면 SDK내에서의 Dialog Popup등이 동작하지 않을 수 있습니다.
        {
            GlobalApplication.globalApplicationContext
        }
    }
}